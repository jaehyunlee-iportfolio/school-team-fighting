...
const styles = StyleSheet.create({
  ...
  apSign: { flexDirection: "row", minHeight: 66 },
  apSignC: {
    flex: 1,
    borderColor: BORDER,
    borderRightWidth: b,
  ...
  drafter: { fontFamily: "NanumPen", fontSize: 22, textAlign: "center" },
  small: { fontSize: 7.5, color: "#333" },
  apImg: { maxHeight: 46, maxWidth: "100%", objectFit: "contain" as const },
